...
- [x] Add integration tests for LineItem API endpoints
    ...
    - [x] Test nested routes under orders
    - [x] Test direct access via `/lineitems`
    - [x] Test validation error cases

- [x] Cross-Feature Tests
    - [x] Create order with line items in a single transaction
    - [x] Update order with multiple line items
    - [x] Delete order and verify cascading deletes
    - [x] Concurrency tests for order updates
...
| 2025-12-18 | 1.0 | All implementation and tests, dropped total cost calculation | Marcus (SM) |
| 2025-12-18 | 1.1 | QA review and test coverage verification | Quinn (QA) |
