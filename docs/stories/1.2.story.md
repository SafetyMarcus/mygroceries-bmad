...
| 2025-10-20 | 1.2 | Re-implemented integration tests to connect to a local PostgreSQL instance directly, without Docker. Tests are currently failing due to connection issues. | James (Full Stack Developer) |
